...
const SingleMovie = ({ setCurrentId }) => {
  const { id } = useParams();
  setCurrentId(id);
  ...
  return (
    <section className="single-movie-container">
      <button className="back-home-page">
        ...
        <div className="movie-info-container">
          <div className="movie-title-info">
            ...
            <div className="movie-info-rate">
              ...
              <h4 className="movie-info-vote">
                {vote_average && vote_average} <span>/10</span>{" "}
              </h4>
            </div>
          </div>
            ...
            <div className="info-container">
              <div className="single-movie-more-info">
                <p className="movie-info">
                  <div className="movie-info-div">Release Date</div>{" "}
                  <div className="movie-info-info">
                    {release_date && release_date}
                  </div>
                </p>
                <p className="movie-info">
                  <div className="movie-info-div">Original Lang</div>{" "}
                  <div className="movie-info-info">
                    {spoken_languages && spoken_languages[0].name}
                  </div>
                </p>
                <p className="movie-info">
                  <div className="movie-info-div">Budget</div>{" "}
                  <div className="movie-info-info">{budget && budget}$</div>
                </p>
                <p className="movie-info">
                  <div className="movie-info-div">Genres</div>{" "}
                  <div className="movie-info-info">
                    {genres &&
                      genres.map((genre) => (
                        <div className="single-movie-genre">{genre.name}</div>
                      ))}
                  </div>
                </p>
                <p className="movie-info">
                  <div className="movie-info-div">Revenue</div>{" "}
                  <div className="movie-info-info">{revenue && revenue}$</div>
                </p>
                <p className="movie-info">
                  <div className="movie-info-div">Overview</div>
                </p>
                <div className="movie-info-info overview">
                  {overview && overview}
                </div>
              </div>
            </div>
          ...
          <div className="similar-movies">
            {similarMovies &&
              ...
              similarMovies.map((movie, index) => {
                return (
                  <div key={index} className="similar-movie-item">
